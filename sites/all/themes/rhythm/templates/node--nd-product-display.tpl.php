...
if ($teaser) { ?>
  <div class = "col-default col-md-3 col-lg-3 mb-60">
    <div class="post-prev-img">
      <?php print isset($content['product:field_images'][0]) ? render($content['product:field_images'][0]) : ''; ?>
      
      <?php print render($content['product:field_sale_text']); ?>
    ...
    <div class="post-prev-text align-center">
        ...
        &nbsp;
        <strong><?php print strip_tags(render($content['product:commerce_price'])); ?></strong>
    </div>
